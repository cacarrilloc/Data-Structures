 ...
 ** Date:   02/09/2016                                       *
 ** Description: This program is an implementation of binary *
 *  search tree that can store any arbitrary struct in its   *
 *  nodes.                                                   *
 ** Input:  Several integer values (known as nodes).         *
 ** Output: Different forms of the tree.                     *
 ************************************************************/
...
struct Node *_addNode(struct Node *cur, TYPE val){
    ...
    /* Create a node if the tree is empty */
    struct Node *newNode;
    ...
    if(cur == 0){ // Base case
        ...
        /* Initialize newNode value and children */
        newNode->val = val;
        newNode->left = 0;
        newNode->right = 0;
        
        /* Return newNode with newValue */
        return newNode;}
    
    else if(compare(val, cur->val) == -1){
        /* Set the left child to be the value returned by _addNode */
        cur->left = _addNode(cur->left, val);}
    
    else{
        /* set the right child to be he value returned by _addNode */
...
int containsBSTree(struct BSTree *tree, TYPE val){
    ...
    while(currentNode != NULL){
        ...
        /* The value could be current's left child */
        else if(compare(val, currentNode->val) == -1){
            currentNode = currentNode->left;}
        
        /* The value could be current's right child */
        else{
...
TYPE _leftMost(struct Node *cur){
    ...
    /* Go through the left children until leftMost is found */
    while(cur->left != 0){
        cur = cur->left;}
    
    /* Retur the value at leftMost */
    return cur->val;
}
...
struct Node *_removeLeftMost(struct Node *cur){
    ...
    if(cur != 0){ // Base case
        ...
        /* If current has a right child and its leftMost element has
           already been removed, return the right child and free leftMost */
        if(cur->left == 0){
            free(cur);
            return cur->right;}
        
        /* Recursive action is performed until cur->left == NULL */
        else
...
struct Node *_removeNode(struct Node *cur, TYPE val) {
    ...
    if(compare(cur->val, val) == 0){ //Base case
        ...
        /* Set left child to _removeNode */
        cur->left = _removeNode(cur->left, val);}
    
    else{
        /* Set right child to _removeNode */
...
#if 1
/************************************************************************
from here to the end of this file are a set of fucntions for testing
the functions of the BST - This is also provided in a  separate file .
*************************************************************************/
/*
